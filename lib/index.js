...
exports.fulfillCondition = exports.resetTracking = exports.skipTracking = exports.startTracking = exports.setup = undefined;
...
var skipTracking = exports.skipTracking = function skipTracking(key) {
  var entries = getEntries();
  var entryIndex = getEntryIndex(key, entries);
...
var handleGoBackEvent = function handleGoBackEvent() {
...
var getLastButOne = function getLastButOne(array) {
...
var emptyConfig = function emptyConfig() {
  var trackingId = window.ga.getAll()[0].get('trackingId');
