...
var fulfillCondition = exports.fulfillCondition = function fulfillCondition(key, condition) {
  ...
  var isInteractivityAlreadyTracked = isEmpty(interactivityConditions);
  var isLoadCompletionAlreadyTracked = isInteractivityAlreadyTracked && isEmpty(loadCompletionConditions);
